...
// Europe
    ...
    denmark_bb.lowerLeft.lat = 8.0899;
    denmark_bb.lowerLeft.lon = 54.8000;
    denmark_bb.upperRight.lat = 57.730;
    ...
    estonia_bb.lowerLeft.lat = 23.340;
    estonia_bb.lowerLeft.lon = 57.475;
    ...
    france_bb.lowerLeft.lat = -54.525;
    france_bb.lowerLeft.lon = 2.053;
    ...
    georgia_bb.lowerLeft.lat = 39.955;
    georgia_bb.lowerLeft.lon = 41.064;
    georgia_bb.upperRight.lat = 43.553;
    georgia_bb.upperRight.lon = 46.637;
    retn.insert(QLatin1String("Georgia"), georgia_bb);

    BoundingBox germany_bb;
    germany_bb.latShift = 0.0;
    germany_bb.lonShift = 0.0;
    germany_bb.lowerLeft.lat = 5.989;
    germany_bb.lowerLeft.lon = 47.302;
    ...
    greece_bb.lowerLeft.lat = 20.150;
    greece_bb.lowerLeft.lon = 34.920;
    ...
    hungary_bb.lowerLeft.lat = 16.202;
    hungary_bb.lowerLeft.lon = 45.759;
    ...
    iceland_bb.lowerLeft.lat = -24.326;
    iceland_bb.lowerLeft.lon = 63.496;
    iceland_bb.upperRight.lat = 66.527;
    iceland_bb.upperRight.lon = -13.610;
    retn.insert(QLatin1String("Iceland"), iceland_bb);

    BoundingBox ireland_bb;
    ireland_bb.latShift = 0.0;
    ireland_bb.lonShift = 0.0;
    ireland_bb.lowerLeft.lat = -9.977;
    ireland_bb.lowerLeft.lon = 51.669;
    ireland_bb.upperRight.lat = 55.132;
    ireland_bb.upperRight.lon = -6.033;
    retn.insert(QLatin1String("Ireland"), ireland_bb);

    BoundingBox italy_bb;
    italy_bb.latShift = 0.0;
    italy_bb.lonShift = 0.0;
    italy_bb.lowerLeft.lat = 6.750;
    italy_bb.lowerLeft.lon = 36.620;
    ...
    kazakhstan_bb.lowerLeft.lat = 6.750;
    kazakhstan_bb.lowerLeft.lon = 40.662;
    ...
    latvia_bb.lowerLeft.lat = 21.056;
    latvia_bb.lowerLeft.lon = 55.615;
    ...
    luxembourg_bb.lowerLeft.lat = 5.674;
    luxembourg_bb.lowerLeft.lon = 49.443;
    ...
    macedonia_bb.lowerLeft.lat = 20.463;
    macedonia_bb.lowerLeft.lon = 40.842;
    macedonia_bb.upperRight.lat = 42.321;
    ...
    malta_bb.lowerLeft.lat = 14.183;
    malta_bb.lowerLeft.lon = 35.786;
    ...
    moldova_bb.lowerLeft.lat = 26.619;
    moldova_bb.lowerLeft.lon = 45.488;
    moldova_bb.upperRight.lat = 48.467;
    ...
    montenegro_bb.lowerLeft.lat = 18.450;
    montenegro_bb.lowerLeft.lon = 41.878;
    ...
    netherlands_bb.lowerLeft.lat = 3.315;
    netherlands_bb.lowerLeft.lon = 50.804;
    ...
    norway_bb.lowerLeft.lat = 4.992;
    norway_bb.lowerLeft.lon = 58.078;
    ...
    poland_bb.lowerLeft.lat = 14.074;
    poland_bb.lowerLeft.lon = 49.027;
    poland_bb.upperRight.lat = 54.852;
    ...
    portugal_bb.lowerLeft.lat = -9.527;
    portugal_bb.lowerLeft.lon = 36.838;
    ...
    romania_bb.lowerLeft.lat = 20.220;
    romania_bb.lowerLeft.lon = 43.688;
    romania_bb.upperRight.lat = 48.220;
    romania_bb.upperRight.lon = 29.626;
    retn.insert(QLatin1String("Romania"), romania_bb);

    BoundingBox serbia_bb;
    serbia_bb.latShift = 0.0;
    serbia_bb.lonShift = 0.0;
    serbia_bb.lowerLeft.lat = 18.830;
    serbia_bb.lowerLeft.lon = 42.245;
    serbia_bb.upperRight.lat = 46.172;
    ...
    slovakia_bb.lowerLeft.lat = 16.880;
    slovakia_bb.lowerLeft.lon = 47.758;
    ...
    spain_bb.lowerLeft.lat = -9.393;
    spain_bb.lowerLeft.lon = 35.947;
    ...
    slovenia_bb.lowerLeft.lat = 13.698;
    slovenia_bb.lowerLeft.lon = 45.452;
    slovenia_bb.upperRight.lat = 46.852;
    slovenia_bb.upperRight.lon = 16.564;
    retn.insert(QLatin1String("Slovenia"), slovenia_bb);

    BoundingBox sweden_bb;
    sweden_bb.latShift = 0.0;
    sweden_bb.lonShift = 0.0;
    sweden_bb.lowerLeft.lat = 11.027;
    sweden_bb.lowerLeft.lon = 55.362;
    ...
    switzerland_bb.lowerLeft.lat = 6.023;
    switzerland_bb.lowerLeft.lon = 45.777;
    ...
    turkey_bb.lowerLeft.lat = 26.043;
    turkey_bb.lowerLeft.lon = 35.822;
    ...
    ukraine_bb.lowerLeft.lat = 22.086;
    ukraine_bb.lowerLeft.lon = 44.361;
